...
/*   Updated: 2026/06/26 00:28:15 by angalleg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    // --- CASO 5: Comparando tipos de datos que no son strings (Arrays de enteros) ---
    int arr1[] = {1, 2, 3, 4};
    int arr2[] = {1, 2, 5, 4};
    printf("5. Arrays de enteros   -> ori: %d | ft: %d\n", memcmp(arr1, arr2, sizeof(int) * 4), ft_memcmp(arr1, arr2, sizeof(int) * 4));
}